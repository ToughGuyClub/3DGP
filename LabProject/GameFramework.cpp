...
void CGameFramework::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYUP:
		...
		case VK_LSHIFT:
			...
			m_pPlayer->m_player_speed = 0.15f;
			break;
		default:
...
{
	CAirplaneMesh* pAirplaneMesh = (CAirplaneMesh*)new CModelMesh("model/jet.obj");
...
void CGameFramework::ProcessInput()
{
	...
	if ((dwDirection != 0) || (cxDelta != 0.0f) || (cyDelta != 0.0f))
	{
		...
		if (dwDirection) m_pPlayer->Move(dwDirection, m_pPlayer->m_player_speed);
	}
